                ...
                <div className="flex items-center justify-between pt-1">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="relative" ref={modelDropdownRef}>
                      ...
                      {isModelDropdownOpen && (
                        <div className="absolute right-0 bottom-full mb-2 w-72 max-h-[260px] overflow-y-auto bg-[#1C1B19] border border-[#2B2A27] rounded-2xl shadow-2xl p-1.5 z-50 text-xs scrollbar-none">
                          <div className="px-2.5 py-1 text-[10px] text-[#706E68] font-semibold uppercase tracking-wider border-b border-[#262522] mb-1">
                            Model Tier
                          </div>
                              ...
                              return (
                                <button
                                  ...
                                  className={`w-full text-left px-2.5 py-2 rounded-xl flex items-center justify-between transition-colors cursor-pointer ${
                                    isSelected
                                      ? 'bg-[#282622] text-white border border-[#3A3833]'
                                      : 'hover:bg-[#22211E] text-[#C4C3BE] border border-transparent'
                                  }`}
                                >
                                  <div className="flex flex-col min-w-0 pr-2">
                                    <div className="flex items-center gap-1.5">
                                      ...
                                      {tier.badge && (
                                        <span className="text-[9px] px-1.5 py-0.2 rounded bg-[#DA7756]/20 text-[#DA7756] font-medium">
                                          {tier.badge}
                                        </span>
                                      )}
                                    </div>
                                    <span className="text-[11px] text-[#8C8A82] truncate mt-0.5">
                                      {tier.tagline}
                                    </span>
                                  </div>
                                  {isSelected && (
